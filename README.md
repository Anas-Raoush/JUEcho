...
After installing dependencies and configuring Amplify, the application can be run on a supported device or emulator using Flutter tooling.

---

## Notes

- Admin users must be manually assigned to the **admin** Cognito group
- File uploads are securely stored in Amazon S3
- The project follows a scalable, production-ready architecture suitable for academic environments
